...
public class CriaArvore {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (NUM_MAX = 1000; NUM_MAX != 11000; NUM_MAX = NUM_MAX + 1000) { // Executa de 1k em 1k
        ...
        //Segundo teste, dos numeros randomicos
        
              for (NUM_MAX = 10000; NUM_MAX != 110000; NUM_MAX = NUM_MAX + 10000) { // Executa de 1k em 1k
            for (insert = 0; insert < NUM_MAX; insert++) { //gera os numeros
                numbers.add(rand.nextInt(398472899)); // insere os numeros no Arraylist
            }
            for (int a : numbers) {
                Item item = new Item(a);
                dicionario.insere(item);
